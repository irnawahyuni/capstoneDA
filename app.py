...
def index():
	...
	average_cltv = int(data['cltv'].mean(axis=0))
	...
	plot_contract_res1 = plot_contract(raw)
	plot_contract_inetservices_res=plot_contract_inetservices(raw)
	...
	return render_template('index.html',
			...
			plot_contract_res=plot_contract_res1,
			plot_contract_inetservices_res=plot_contract_inetservices_res
		)
